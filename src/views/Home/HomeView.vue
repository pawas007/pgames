  ...
  <div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
              <div class="card_custom card--catalog">
                <a href="details.html" class="card__cover">
                  <img src="@/assets/img/cards/gameposter2.jpg" alt="">
    ...
    <section class="section">
      <div class="container">
        ...
        <div class="row">
          <div class="col col-6">
            <div class="card_custom card--big">
              <a href="details.html" class="card__cover">
                <img src="@/assets/img/cards/gameposter.jpg" alt="">
              </a>
          ...
          <div class="col-12 col-md-12 col-lg-6">
            <div class="post post--big">
              <a href="article.html" class="post__img">
                <img src="@/assets/img/posts/post.jpg" alt="">
              </a>

              <div class="post__content">
                <a href="#" class="post__category">NFS</a>
                <h3 class="post__title"><a href="article.html">New hot race from your favorite computer games studio</a>
                </h3>
                <div class="post__meta">
                  ...
                  <span class="post__comments"><svg xmlns='http://www.w3.org/2000/svg' width='512' height='512'
                                                    viewBox='0 0 512 512'><path
