      ...
      <div class="row">
        <div class="col-12">
          <div class="profile">
            ...
            <ul class="nav-account nav-tabs-account profile__tabs" id="profile__tabs" >
              <li class="nav-item-account">
                <a class="nav-link-account">My purchases</a>
              </li>

              <li class="nav-item-account">
                <a class="nav-link-account">Subscriber</a>
              </li>
            </ul>

            <button class="profile__logout" type="button" @click.prevent="LOGOUT">
              ...
              <div class="table-responsive table-responsive--border">
                <table class="profile__table">
                  ...
                  <tr>
                    ...
                    <th><a href="#">Platform <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M9.71,10.21,12,7.91l2.29,2.3a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42l-3-3a1,1,0,0,0-1.42,0l-3,3a1,1,0,0,0,1.42,1.42Zm4.58,4.58L12,17.09l-2.29-2.3a1,1,0,0,0-1.42,1.42l3,3a1,1,0,0,0,1.42,0l3-3a1,1,0,0,0-1.42-1.42Z"></path></svg></a></th>
                    ...
                    <th><a href="#">Price <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M9.71,10.21,12,7.91l2.29,2.3a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42l-3-3a1,1,0,0,0-1.42,0l-3,3a1,1,0,0,0,1.42,1.42Zm4.58,4.58L12,17.09l-2.29-2.3a1,1,0,0,0-1.42,1.42l3,3a1,1,0,0,0,1.42,0l3-3a1,1,0,0,0-1.42-1.42Z"></path></svg></a></th>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="profile__img">
                        <img src="@/assets/img/cards/5.jpg" alt="">
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="profile__img">
                        <img src="@/assets/img/cards/7.jpg" alt="">
                      </div>
                    </td>
