    ...
    <section class="section">
      <div class="container">
        <div class="row">
          <!-- section text -->
          <div class="col-12">
            <p class="section__text">It is a long established fact that a reader will be distracted by the readable
            ...
            <p class="section__text">Many desktop publishing packages and <a href="#">web page</a> editors now use Lorem
            ...
            <p class="section__text">All the Lorem Ipsum generators on the <b>Internet</b> tend to repeat predefined
          ...
          <div class="col-12">
            <div class="section__list">
              <ol>
                <li>
                  <h4>Determination of personal information of users
                  </h4>
                  <ol>
...
export default {
  name: "Policy",
  components: {BreadcrumbsDefault, PartnersCarousel},
}
</script>
